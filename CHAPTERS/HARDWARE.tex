...
\begin{itemize}
    \item MCI (Module Communication Interface - modul potřebný pro drátové připojení ostatních modulů - viz. \autoref{subsec:MCI})
...
\subsection{MCI - Module Communication Interface}
\label{subsec:MCI}
